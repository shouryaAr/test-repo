...
import numpy as np
import cv2
import Mask_RCNN_TF2.mrcnn.config
import Mask_RCNN_TF2.mrcnn.utils
from Mask_RCNN_TF2.mrcnn.model import MaskRCNN
...
class Config(Mask_RCNN_TF2.mrcnn.config.Config):
    NAME = "model_config"
    IMAGES_PER_GPU = 1
    GPU_COUNT = 1
    NUM_CLASSES = 81
...
if not os.path.exists(COCO_MODEL_PATH):
    Mask_RCNN_TF2.mrcnn.utils.download_trained_weights(COCO_MODEL_PATH)
