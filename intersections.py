...
t=((int(hcord[0])-int(vcord[0]))(int(hcord)[2]-int(hcord)[3])-(int(hcord)[2]-int(vcord)[2])(int(hcord)[0]-int(hcord)[1]))/((int(vcord)[0]-int(vcord)[1])(int(hcord)[2]-int(hcord)[3])-(int(vcord)[2]-int(vcord)[3])(int(hcord)[0]-int(hcord)[1]))
print(vcord[0]+t(vcord[1]-vcord[0]))